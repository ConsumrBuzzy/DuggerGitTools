"""IDE Bridge - Universal AI IDE persona synchronization.

The "Omni-IDE Handshake" - syncs AGENT_PROTOCOL + PERSONA across all AI IDEs.
"""
...
class IDEBridge:
    ...
    def __init__(self, project_root: Path):
        ...
        self.logger = logger.bind(component="IDEBridge")
