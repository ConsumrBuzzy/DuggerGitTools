...
class VersionFormat(BaseModel):
    ...
    replacement: str | None = Field(None, description="Replacement template")
...
class DuggerSchema(BaseModel):
    ...
    multi_provider: MultiProviderConfig | None = Field(None, description="Multi-provider configuration")
...
class SchemaLoader:
    ...
    def _detect_multi_provider(self) -> MultiProviderConfig | None:
