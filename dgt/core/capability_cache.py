...
class CapabilityCache:
    ...
    def get_cached_result(self, tool_name: str, check_command: List[str]) -> Optional[bool]:
    ...
    def _is_cache_valid(self, cache_entry: Dict, current_time: Optional[float] = None) -> bool:
        """Check if cache entry is still valid."""
