...
from .schema import DuggerSchema, ToolConfig, CapabilityCheck
...
class UniversalAutoFixer:
    ...
    def _should_run_tool(self, tool_config: ToolConfig, staged_files: Optional[List[Path]]) -> bool:
...
class MultiProviderAutoFixer:
    ...
    def _run_provider_fixes(self, provider_name: str, staged_files: Optional[List[Path]]) -> bool:
