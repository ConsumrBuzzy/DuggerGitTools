...
class DocsMerger:
    ...
    def _collect_python_docs(self) -> Optional[Dict[str, Any]]:
    ...
    def _collect_rust_docs(self) -> Optional[Dict[str, Any]]:
    ...
    def _collect_chrome_docs(self) -> Optional[Dict[str, Any]]:
    ...
    def _collect_api_docs(self) -> Optional[Dict[str, Any]]:
    ...
    def _collect_arch_docs(self) -> Optional[Dict[str, Any]]:
    ...
    def _collect_readme_docs(self) -> Optional[Dict[str, Any]]:
    ...
    def _extract_python_module_docs(self, py_file: Path) -> Optional[Dict[str, Any]]:
    ...
    def _extract_rust_module_docs(self, rs_file: Path) -> Optional[Dict[str, Any]]:
    ...
    def _extract_rust_doc_comments(self, content: str) -> Optional[str]:
