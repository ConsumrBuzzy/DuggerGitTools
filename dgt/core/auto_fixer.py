...
class AutoFixer:
    ...
    def _run_python_fixes(self, staged_files: list[Path] | None) -> None:
    ...
    def _run_chrome_fixes(self, staged_files: list[Path] | None) -> None:
...
"""
    ...
    def _get_python_files(self, staged_files: list[Path] | None) -> list[str]:
    ...
    def _get_js_files(self, staged_files: list[Path] | None) -> list[str]:
