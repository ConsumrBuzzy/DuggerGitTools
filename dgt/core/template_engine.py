...
from .schema import ProjectType
...
class TemplateEngine:
    ...
    def _select_template(self, project_type: ProjectType, template_name: str | None) -> Path | None:
...
"""
    ...
    def _load_template_info(self, template_dir: Path) -> dict[str, Any] | None:
