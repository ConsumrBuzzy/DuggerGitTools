...
class ProviderConfig(BaseModel):
    ...
    pre_flight_checks: list[str] = Field(default_factory=list, description="Pre-flight checks to run")
    post_flight_checks: list[str] = Field(default_factory=list, description="Post-flight checks to run")
...
class DGTConfig(BaseModel):
    ...
    auto_push: bool = Field(default=True, description="Automatically push after successful commit")
    ...
    @classmethod
    def from_project_root(cls, project_root: Optional[Path] = None) -> "DGTConfig":
